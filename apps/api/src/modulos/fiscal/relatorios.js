 ...
 *
 * Mesma implementação de `modulos/vendas/relatorios.js` — cada módulo tem sua
 * própria cópia (docs/ARQUITETURA.md: nenhum módulo importa código de dentro
 * de outro), em vez de uma dependência cruzada só por causa de um utilitário
 * sem estado.
 *
