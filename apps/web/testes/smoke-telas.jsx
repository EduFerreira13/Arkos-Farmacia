...
const paginas = {
  ...
  Perdas: (await import("../src/paginas/Perdas.jsx")).Perdas,
...
const RESPOSTAS = [
  ...
  [/\/api\/estoque\/produtos\/proximo-codigo/, { codigo: "PRD-00002" }],
      ...
      movimentacoes: [
        {
          ...
          tipo: "perda",
          quantidade: 2,
          motivo: "Avaria no transporte — caixa amassada",
          usuario_id: USUARIO.id,
  ...
  [
    /\/api\/compras\/pedidos\/[^/?]+$/,
    {
      pedido: {
        ...
        numero: "PC-2026-00042",
        fornecedor_id: PRODUTO.fornecedor_id,
        fornecedor_nome: "Distribuidora Panvel Norte LTDA",
      ...
      notas: [
        {
          ...
          numero: "12",
          serie: "1",
          url_consulta: "https://homologacao.focusnfe.com.br/consulta",
          mensagem_erro: null,
...
const TELAS = [
  ...
  ["/cadastros/usuarios", "Pesquisar usuário"],
